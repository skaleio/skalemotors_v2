          ...
          <div className="flex items-center space-x-4">
            <div className="w-12 h-12 rounded-xl flex items-center justify-center shadow-lg overflow-hidden animate-pulse">
              <svg width="48" height="48" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <rect x="9" y="11" width="6" height="5" rx="1" fill="rgba(190,24,93,0.3)" stroke="rgba(190,24,93,0.5)" strokeWidth="0.5"/>
                <rect x="17" y="11" width="6" height="5" rx="1" fill="rgba(190,24,93,0.3)" stroke="rgba(190,24,93,0.5)" strokeWidth="0.5"/>
                ...
                <rect x="7" y="19" width="1" height="2" fill="#be185d"/>
                <rect x="24" y="19" width="1" height="2" fill="#be185d"/>
