-- Reparación: "function gen_random_bytes(integer) does not exist"
-- Causas habituales en Supabase: (1) extensión pgcrypto no habilitada, (2) funciones en schema "extensions"
--   pero la RPC solo tenía search_path = public.

-- Habilitar pgcrypto (en Dashboard: Database → Extensions → pgcrypto → Enable, también sirve)
CREATE EXTENSION IF NOT EXISTS pgcrypto WITH SCHEMA extensions;
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- Permitir uso del schema extensions en despliegues Supabase
