-- Amplía alertas de estancamiento: más destinatarios, leads CRM (en_espera + updated_at),
-- notificaciones de vehículos sin publicar, y roles que pueden disparar el sync.
...
comment on function public.sync_stale_leads_to_pending_tasks(int) is
  'Leads CRM sin cambio de estado ni actualización en N días: pending_tasks + notificaciones a gerencia y vendedor asignado.';

-- ============================================================================
-- sync_stale_consignaciones_to_pending_tasks (más destinatarios de notificación)
-- ============================================================================
...
-- ============================================================================
-- sync_unpublished_vehicles_to_pending_tasks + notificaciones in-app
-- ============================================================================
drop function if exists public.sync_unpublished_vehicles_to_pending_tasks(int);
...
comment on function public.sync_unpublished_vehicles_to_pending_tasks(int) is
  'Vehículos disponibles sin publicar > N días: pending_tasks + notificaciones in-app.';
